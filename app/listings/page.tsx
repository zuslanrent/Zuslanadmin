                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-1.5 mb-0.5">
                            ...
                            {(() => {
                              const { isVip, isFree } = formatPlanInfo(listing);
                              return (
                                <>
                                  {isVip && (
                                    <span className="px-1.5 py-0.5 bg-amber-100 text-amber-700 text-[9px] font-bold rounded shrink-0">
                                      ⭐ VIP
                                    </span>
                                  )}
                                  {isFree && (
                          ...
                          <div className="flex items-center gap-3 text-xs text-gray-400">
                            ...
                            {(() => {
                              const { daysLeft } = formatPlanInfo(listing);
                      ...
                      <div>
                        ...
                        <div className="text-xs font-mono text-brand-600 font-bold mt-0.5">
                          {price}/өдөр
                        </div>
                      </div>
